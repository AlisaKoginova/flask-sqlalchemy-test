...
data_actor = {'name': 'qwerty', 'gender': 'female', 'date_of_birth': dt.strptime('16.05.1986', '%d.%m.%Y').date()}
data_actor_upd = {'name': 'not qwerty', 'gender': 'male', 'date_of_birth': dt.strptime('16.05.2000', '%d.%m.%Y').date()}

data_movie = {'name': 'titanic', 'genre': 'action', 'year': 2007}
data_movie_upd = {'name': 'moscow', 'genre': 'bad movie', 'year': 2014}
